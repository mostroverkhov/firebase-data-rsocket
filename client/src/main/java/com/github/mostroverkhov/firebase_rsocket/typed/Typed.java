...
public interface Typed {
  <T> Function<ReadResponse, TypedReadResponse<T>> dataWindowOf(Class<T> windowItemsType);

  <T> Function<NotifResponse, TypedNotifResponse<T>> notificationsOf(Class<T> itemType);
}
