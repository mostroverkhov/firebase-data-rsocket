...
import static com.github.mostroverkhov.firebase_rsocket.model.read.ReadRequest.OrderBy.CHILD;
import static com.github.mostroverkhov.firebase_rsocket.model.read.ReadRequest.OrderBy.KEY;
import static com.github.mostroverkhov.firebase_rsocket.model.read.ReadRequest.OrderBy.VALUE;
...
public class ReadBuilder {
  ...
  public ReadRequest build() {
    ...
    return new ReadRequest(path, windowSize, orderDir, orderBy, key, startWith);
  }
  ...
  private static void assertNotEmpty(String[] dataPath) {
